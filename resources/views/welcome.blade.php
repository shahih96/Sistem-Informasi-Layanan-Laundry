      ...
      <div class="mt-10 grid gap-6 md:grid-cols-4">
        ...
        <div class="bg-white rounded-2xl shadow hover:shadow-lg transition p-6">
          <div class="relative w-full rounded-lg overflow-hidden aspect-[16/9]">
            <img src="{{ asset('images/layanan-1.jpg') }}" alt="Self Service" class="w-full h-full object-cover" onerror="this.style.display='none'">
          </div>
        ...
        <div class="bg-white rounded-2xl shadow hover:shadow-lg transition p-6">
          <div class="relative w-full rounded-lg overflow-hidden aspect-[16/9]">
            <img src="{{ asset('images/layanan-2.jpg') }}" alt="Cuci Lipat" class="w-full h-full object-cover" onerror="this.style.display='none'">
          </div>
        ...
        <div class="bg-white rounded-2xl shadow hover:shadow-lg transition p-6">
          <div class="relative w-full rounded-lg overflow-hidden aspect-[16/9]">
            <img src="{{ asset('images/layanan-3.jpg') }}" alt="Cuci Setrika" class="w-full h-full object-cover" onerror="this.style.display='none'">
          </div>
        ...
        <div class="bg-white rounded-2xl shadow hover:shadow-lg transition p-6">
          <div class="relative w-full rounded-lg overflow-hidden aspect-[16/9]">
            <img src="{{ asset('images/layanan-4.jpg') }}" alt="Antar Jemput" class="w-full h-full object-cover" onerror="this.style.display='none'">
          </div>
    ...
    <section id="pesan" class="scroll-mt-16 md:scroll-mt-20 max-w-7xl mx-auto px-4 py-16">
      <div class="grid md:grid-cols-2 gap-10 items-center">
        <div class="h-full flex flex-col justify-center space-y-3 md:space-y-5 lg:space-y-6">
          ...
          <p class="text-gray-600">“Layanan laundry berkualitas dengan harga terjangkau, proses cepat, dan pelayanan ramah.”</p>
        ...
        <div class="w-full rounded-xl bg-gray-200 overflow-hidden">
          <img src="{{ asset('images/cta.jpg') }}" alt="CTA" class="w-full h-72 md:h-[22rem] object-cover" onerror="this.style.display='none'">
        </div>
      </div>
    </section>
