...
class LookupSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $service = [
            ...
            ['nama_service' => 'Cuci Lipat Express Max 7Kg',       'harga_service' => 45000, 'created_at' => $now, 'updated_at' => $now],
            ...
            ['nama_service' => 'Plastik Laundry',                  'harga_service' => 2000,  'created_at' => $now, 'updated_at' => $now],
